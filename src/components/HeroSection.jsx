      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
            ...
            that improve user experiences. With expertise in modern web
            technologies, I strive to deliver cutting-edge solutions that meet
            the needs of users and businesses alike. My commitment to quality
            and innovation drives me to continuously learn and implement the
